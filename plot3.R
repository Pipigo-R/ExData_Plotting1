...
png(filename = "./figure/plot3.png", width = 480, height = 480, units = "px") #open PNG device

## Plot 3: plot 3 Energy sub metering (3 sub-meterings)
plot(subPwr$datetime, subPwr$Sub_metering_1, col="black", type="l", 
     xlab="", ylab="Energy sub metering")
lines(subPwr$datetime, subPwr$Sub_metering_2, col="red", type="l")
lines(subPwr$datetime, subPwr$Sub_metering_3, col="blue", type="l")
