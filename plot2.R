...
png(filename = "./figure/plot2.png", width = 480, height = 480, units = "px") #open PNG device

## Plot 2: plot Global active power vs. datetime
plot(subPwr$datetime, subPwr$Global_active_power,type="l", 
